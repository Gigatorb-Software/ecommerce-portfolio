...
const ServiceApp = () => {
  return (
    // <section className="mx-auto my-10 flex max-w-xl flex-col  px-4 py-2 text-gray-700 sm:border-8 sm:px-10 lg:max-w-screen-lg lg:flex-row">
    //   <div className="mr-2">
    ...
    //   </div>
    //   <div className="h-50">
    //     <img className="h-full w-full object-contain" src={ecommercephoto} />
    //   </div>
    // </section>/
    <section className="py-10  text-blue-900 sm:py-16 lg:py-24">
      <div className="mx-auto max-w-5xl px-4 sm:px-6 lg:px-4">
        <div className="mx-auto max-w-xl text-center">
          <h2 className="text-3xl font-bold leading-2 sm:text-4xl sm:leading-tight">
            ...
            <div className="py-10 px-6">
              <div className="flex items-center">
                <h3 className="relative ml-2 inline-block text-4xl font-bold leading-none">
                  <span className="absolute -top-2 h-2 w-full bg-blue-200" />
                  328
                </h3>
